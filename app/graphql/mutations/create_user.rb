class Mutations::CreateUser < Mutations::BaseMutation
  ...
  def resolve(name:, email:, password_digest:, mentor:, address:,
    ...
    user_info = { name: name, email: email, password_digest: password_digest, address: address, mentor: mentor}
    ...
    User.create_user_and_info(user_info, profile_info, mentor_info)
