module Types
  class QueryType < Types::BaseObject
    ...
    def mentors(email:, location: nil, gender: nil, field: nil, expert_lvl: nil)
      User.get_all_mentors({user_email: email, location: location, gender: gender, field: field, expert_lvl: expert_lvl})
    end
