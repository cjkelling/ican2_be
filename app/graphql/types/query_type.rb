module Types
  class QueryType < Types::BaseObject
    ...
    def mentors(email:, distance: nil, gender: nil, field: nil, expert_lvl: nil)
      User.get_all_mentors({user_email: email, distance: distance, gender: gender, field: field, expert_lvl: expert_lvl})
    end
